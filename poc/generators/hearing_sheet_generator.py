...
"""
    ...
    def _search_similar_hearing_sheets(
        ...
        6.  「費用感・契約方法」などの「営業目線」のヒアリング項目と「技術要件・技術仕様」などの「エンジニア目線」のヒアリング項目を分けてヒアリング項目を作成してください。
...
"""
        ...
        try:
            ...
            hearing_sheet = extract_content(response)
...
"""
    ...
    def generate(
        ...
        # RAG結果を保存（思考プロセス分析用）
        self._last_rag_results = similar_cases_text
